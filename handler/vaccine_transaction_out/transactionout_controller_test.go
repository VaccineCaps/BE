...
func (m *MockSvc) CreateVaccinesTransactionService(transaction model.VaccineTransactionsOut) error {
	ret := m.Called()
	return ret.Error(0)
}
func (m *MockSvc) UpdateTransactionByIDService(id int, transaction model.VaccineTransactionsOut) error {return nil}
func (m *MockSvc) GetAllTransactionService() []model.VaccineTransactionsOut {return []model.VaccineTransactionsOut{}}
func (m *MockSvc) GetTransactionByIDService(id int) (transaction []model.VaccineTransactionsOut, err error) {return transaction, nil}
